    ...
    while not game_over:
        ...
        if x+ imageWidth > x_block:
            if x < x_block + block_width:
                #print('possibly with in the boundaries of x upper')
                if y < block_height:
        ...
        pygame.display.update()
        clock.tick(80) #60 fps per second
